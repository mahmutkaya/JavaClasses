...
public class Lists01 {
	...
	public static void main(String[] args) {
		/*
		 * What are the differences between Arrays and Lists? 1)Arrays are fixed in
		 * length but Lists are flexible in length "Lists are resizable Arrays" 2)When
		 * you create an array you have to declare the length but for lists no
		 * declaration 3)When you add a new element to an array you have to create a new
		 * array but for lists no need to create a new list. You can add new elements
		 * directly
		 * 
		 * Note 1:Like Arrays, we cannot use different data types in a List Note 2:In
		 * Arrays we can use primitives and references as data type but In lists we
		 * cannot use primitives and references every time we have to use non-primitives
		 */
		...
		// Run Time Error. Do not use set() to add new elements. set() is just for
		// updating
