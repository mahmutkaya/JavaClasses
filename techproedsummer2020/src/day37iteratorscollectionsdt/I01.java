...
public class I01 {
	...
	public static void main(String[] args) {
		...
		// Loops cannot update a list, loops can navigate among the elements but cannot
		// update them
		for (int w : list) {
			w = w + 5;
		}
		...
		/*
		 * 1)Create a list whose elements are String and every element has more than 4
		 * characters 2)Make last 3 characters of every element like *** 3)Use
		 * ListIterator
		 */
